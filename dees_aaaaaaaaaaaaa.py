...
snakes = [random.randint(1, 100) for _ in range(5)]  # List of snake
ladders = [random.randint(1, 100) for _ in range(6)]   # Ladder positions and where they take you
